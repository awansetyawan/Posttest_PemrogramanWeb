<?php
    ...
    if (isset($_POST['transfer'])){
        ...
        if(move_uploaded_file($tmp, "../../pembayaran/$gambar_baru")){
            ...
            "INSERT INTO pesanan (nama, gitar, jumlah, alamat, email, whatsapp, waktu, bukti) 
            VALUES ('$nama', '$gitar', '$jumlah', '$alamat', '$email', '$wa', '$waktu', '$gambar_baru')");
...
<body>
    ...
    <main id="dark">
        ...
        <div class="hasil">
            ...
            <div class="bawah">
                *Lakukan pembayaran melalui pesan yang dikirim melalui email lalu kirim bukti transfer dibawah ini :
            </div>
            <br>
