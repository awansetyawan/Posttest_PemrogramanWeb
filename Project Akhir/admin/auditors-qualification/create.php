...
$auditor = find("auditors", $_GET['auditor_id']);
$standards = all("standards");

if (isset($_POST['standard_id'])) {
  store("auditor_qualifications");
  flash("Tambah kualifikasi auditor berhasil!", "success");
  header("Location: ../auditors/show.php?id=" . $_GET['auditor_id']);
}
  ...
  <div class="card mb-3">
    <div class="card-header">
      <div class="d-flex align-items-center justify-content-between">
        <h3>Tambah Kualifikasi Auditor</h3>
      </div>
    </div>
    <div class="card-body">
      <form class="form" action="" method="POST" enctype="multipart/form-data">
        <input type="hidden" name="auditor_id" value="<?= $_GET['auditor_id'] ?>">
        ...
        <div class="form-control">
          ...
          <div class="input-wrapper">
            <input type="date" class="w-100" name="expiration_date" required>
          </div>
        </div>
